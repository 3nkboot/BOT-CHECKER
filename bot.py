...
def check_card(ccx):
    ...
    try:
        ...
        r1 = session.get('https://www.rarediseasesinternational.org/donations/donate/', headers=headers1)
        
        # استخراج البيانات - السطر 278 كان هنا المشكلة
        ...
        data2 = {
            ...
            'card_name': 'marwan test',
            'card_exp_month': mm,
            'card_exp_year': f'20{yy}',
        ...
        data3 = MultipartEncoder({
            ...
            'card_name': (None, 'marwan test'),
            'card_exp_month': (None, mm),
            'card_exp_year': (None, f'20{yy}'),
