...
# قائمة لتخزين البطاقات أثناء الفحص المتعدد
checking_cards = {}
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # التحقق من الصلاحية إذا تم تحديد معرف المشرف
    if ALLOWED_USER_ID and str(user.id) != ALLOWED_USER_ID:
        await update.message.reply_text("❌ عذراً، هذا البوت للاستخدام الخاص فقط.")
        return
